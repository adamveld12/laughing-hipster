...
description: This skill should be used when reviewing or editing copy to ensure adherence to vdhsn's style guide. It provides a systematic line-by-line review process for grammar, punctuation, mechanics, and style guide compliance.
---

# vdhsn Style Editor

This skill provides a systematic approach to reviewing copy against vdhsn's comprehensive style guide. It transforms Claude into a meticulous line editor and proofreader specializing in grammar, mechanics, and style guide compliance.

## When to Use This Skill

Use this skill when:
- Reviewing articles, blog posts, newsletters, or any written content
- Ensuring copy follows vdhsn's specific style conventions
- Providing feedback on grammar, punctuation, and mechanics
- Flagging deviations from the vdhsn style guide
...
- Adherence to vdhsn style guide rules
...
The complete vdhsn style guide is included in `references/EVERY_WRITE_STYLE.md`. Key areas to focus on:
...
Based on vdhsn's style guide, pay special attention to:
