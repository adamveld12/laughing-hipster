...
Default plugins from `install_script.sh`: asdf, ssh, vim, git-extras, kubectl, helm, starship, extras, tmux, wezterm, nvim
...
- Git configuration: `plugins/git-extras/defaults.d/.gitconfig`
